...
public enum MultiTableViewLayouts {
...
public protocol MultiTableViewDataSource: AnyObject {
...
open class MultiTableView: UIView, UIScrollViewDelegate {
    // MARK:- Public property
    public weak var dataSource: MultiTableViewDataSource?
    
    public var rightColumnWidth: CGFloat = 50.0 {
        didSet {
    ...
    private func initView() {
        ...
        let leftCellNib = UINib(nibName: "LeftTableViewCell", bundle: .module)
        leftTableView.register(leftCellNib, forCellReuseIdentifier: "LeftTableViewCell")
        let rightCellNib = UINib(nibName: "RightTableViewCell", bundle: .module)
